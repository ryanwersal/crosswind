...
from __future__ import print_function"""
    ...
    def test_crlf_newlines(self):
        ...
        try:
            ...
            fixes = refactor.get_fixers_from_package("fixer_suites.two_to_three.fixes")
...
"""
    ...
    def test_explicit(self):
        ...
        rt = self.rt(fixers=["crosswind.tests.data.fixers.myfixes.fix_explicit"])
        self.assertEqual(len(rt.post_order), 0)

        rt = self.rt(explicit=["crosswind.tests.data.fixers.myfixes.fix_explicit"])
