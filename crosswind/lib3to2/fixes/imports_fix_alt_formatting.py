...
class FixImports(fixer_base.BaseFix):
    ...
    def fix_submod_import(self, imported, name, node):
        ...
        if missed:
            self.warning(node, "Imported names not known to crosswind to be part of the package %s.  Leaving those alone... high probability that this code will be incorrect." % (name))
